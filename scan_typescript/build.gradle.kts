...
dependencies {
    ...
    implementation("com.phodal.chapi:chapi-domain:0.1.9")
    implementation("com.phodal.chapi:chapi-ast-typescript:0.1.9")
    implementation("com.phodal.chapi:chapi-application:0.1.9")
