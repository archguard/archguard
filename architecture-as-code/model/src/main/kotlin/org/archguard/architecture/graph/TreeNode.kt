...
data class TreeNode(val name: String, val children: MutableList<TreeNode> = mutableListOf()) {
    companion object {
         ...
         * e.g. `["org.archguard", "org.archguard.scanner.architecture", "org.archguard.backend"]`.
         * @return the root node of the package tree
         *
         * for example:
         * ```kotlin
         * val packageNames = listOf("org.archguard", "org.archguard.scanner.architecture", "org.archguard.backend")
