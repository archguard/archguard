...
class CircularDependencyService(val circularDependencyRepository: CircularDependencyRepository) {
    ...
    private fun getCircularDependencyWithTotalCount(
        systemId: Long,
        limit: Long,
        offset: Long,
        type: CircularDependencyType
    ): Triple<List<String>, Long, Int> {
    ...
    fun getModuleCircularDependencyWithTotalCount(systemId: Long, limit: Long, offset: Long): Triple<List<CircularDependency<ModuleVO>>, Long, Int> {
    ...
    fun getPackageCircularDependencyWithTotalCount(systemId: Long, limit: Long, offset: Long): Triple<List<CircularDependency<PackageVO>>, Long, Int> {
    ...
    fun getClassCircularDependencyWithTotalCount(systemId: Long, limit: Long, offset: Long): Triple<List<CircularDependency<ClassVO>>, Long, Int> {
    ...
    fun getMethodCircularDependencyWithTotalCount(systemId: Long, limit: Long, offset: Long): Triple<List<CircularDependency<MethodVO>>, Long, Int> {
