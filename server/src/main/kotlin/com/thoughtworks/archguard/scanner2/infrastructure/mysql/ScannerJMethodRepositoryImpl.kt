...
import com.thoughtworks.archguard.scanner2.infrastructure.po.JMethodPO
...
class ScannerJMethodRepositoryImpl(val jdbi: Jdbi) : JMethodRepository {
    ...
    override fun findMethodsByModuleAndClass(systemId: Long, module: String?, name: String): List<JMethod> {
        ...
        val sql = "SELECT id, name, clzname as clazz, module, returntype, argumenttypes, access FROM code_method WHERE clzname='$name' AND system_id='$systemId' " + moduleFilter
