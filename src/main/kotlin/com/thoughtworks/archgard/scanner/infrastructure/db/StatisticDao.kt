...
interface StatisticDao {
    @SqlBatch("insert into Statistic (id, systemName, packageName, typeName, `lines`, fanin, fanout, updateAt, createAt) " +
            "values (:statistic.id, :statistic.systemName, :statistic.packageName, :statistic.typeName," +
