...
interface ClassStatisticDao {
    @SqlBatch("insert into ClassStatistic (id, systemId, moduleName, packageName, typeName, `lines`, fanin, fanout, updateAt, createAt) " +
            "values (:classStatistic.id, :classStatistic.systemId, :classStatistic.moduleName, :classStatistic.packageName, :classStatistic.typeName," +
