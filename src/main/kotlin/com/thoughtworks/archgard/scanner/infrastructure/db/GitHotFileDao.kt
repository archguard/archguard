...
interface GitHotFileDao {
    @SqlBatch("insert into git_hot_file (system_id, repo, name, module_name, class_name, modified_count, jclass_id) " +
            "values (:gitHotFile.systemId, :gitHotFile.repo, :gitHotFile.name, :gitHotFile.moduleName, :gitHotFile.className, :gitHotFile.modifiedCount, :gitHotFile.jclassId)")
