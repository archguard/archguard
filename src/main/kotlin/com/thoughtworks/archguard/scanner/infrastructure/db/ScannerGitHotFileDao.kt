...
interface ScannerGitHotFileDao {
    @SqlBatch("insert into scm_git_hot_file (system_id, repo, path, module_name, class_name, modified_count, jclass_id) " +
    ...
    @SqlUpdate("delete from scm_git_hot_file where system_id = :systemId")
