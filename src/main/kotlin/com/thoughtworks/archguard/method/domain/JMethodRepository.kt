...
interface JMethodRepository {
    ...
    fun findMethodByModuleAndClazzAndName(moduleName: String, clazzName: String, methodName: String): JMethod?
    fun findMethodByClazzAndName(clazzName: String, methodName: String) : JMethod?
}