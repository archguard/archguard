...
data class ClassCouplingDtoForWriteInfluxDB(val systemId: Long, val classCoupling: ClassCoupling) {
    fun toInfluxDBRequestBody(): String {
        return "class_coupling,class_name=${classCoupling.jClassVO.name},package_name=${classCoupling.jClassVO.getPackageName()},module_name=${classCoupling.jClassVO.module},project_id=${systemId} " +
