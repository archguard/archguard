...
data class MetricClassCouplingWritePO(val classId: String,
                                      val systemId: Long,
                                      val innerFanIn: Int,
                                      val innerFanOut: Int,
                                      val outerFanIn: Int,
    ...
    companion object {
        fun fromClassCoupling(systemId: Long, classCoupling: ClassCoupling): MetricClassCouplingWritePO {
            return MetricClassCouplingWritePO(classCoupling.jClassVO.id!!, systemId, classCoupling.innerFanIn, classCoupling.innerFanOut,
