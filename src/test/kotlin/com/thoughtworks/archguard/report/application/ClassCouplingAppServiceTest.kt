...
internal class ClassCouplingAppServiceTest {
    ...
    fun should_filter_not_pass_quality_gateway_coupling_data() {
        ...
        val classCoupling1 = ClassCoupling("id1", "m1", "p1", "c1", 10, 20, 0.8, 0.6)
        ...
        assertThat(couplingFilterByQualityGate).containsExactlyElementsOf(listOf(classCoupling1, classCoupling3))
    }
}