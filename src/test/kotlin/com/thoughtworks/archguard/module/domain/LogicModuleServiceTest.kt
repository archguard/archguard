...
class LogicModuleServiceTest {
    ...
    fun `should get class module by single full match`() {
        val lg1 = LogicModule("id1", "lg1", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("a.b.c.d")))
        val lg2 = LogicModule("id2", "lg2", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("a.b.c")))
        val logicModules: List<LogicModule> = listOf(lg1, lg2)
        val classModule = getModule(logicModules, createModuleMember("a.b.c"))
    ...
    fun `should get class module by multi full match`() {
        val lg1 = LogicModule("id1", "lg1", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("a.b.c.d")))
        val lg2 = LogicModule("id2", "lg2", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("a.b.c")))
        val lg3 = LogicModule("id3", "lg3", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("a.b.c")))
        val lg4 = LogicModule("id4", "lg4", listOf(createModuleMember("a"), createModuleMember("a.b.c"), createModuleMember("a.b.c.d")))
    ...
    fun `should get class module by single start with match`() {
        val lg1 = LogicModule("id1", "lg1", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("a.b.c.d")))
        val lg2 = LogicModule("id2", "lg2", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("abc")))
        val lg3 = LogicModule("id3", "lg3", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("abc.d.e.d.f"), createModuleMember("abc.d.e.d")))
        val lg4 = LogicModule("id4", "lg4", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("abc.d.e.d"), createModuleMember("abc.d.e")))
        val logicModules: List<LogicModule> = listOf(lg1, lg2, lg3, lg4)
        val classModule = getModule(logicModules, createModuleMember("abc.d.e.d.f.g"))
    ...
    fun `should get class module by multi start with match`() {
        ...
        val lg3 = LogicModule("id3", "lg3", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("abc.d.e.d.f"), createModuleMember("abc.d.e.d")))
        val lg4 = LogicModule("id4", "lg4", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("abc.d.e.d"), createModuleMember("abc.d.e")))
        val lg5 = LogicModule("id5", "lg5", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("abc.d.e.d.f"), createModuleMember("abc.d.e")))
        val lg6 = LogicModule("id6", "lg6", listOf(createModuleMember("a"), createModuleMember("a.b"), createModuleMember("abc.d.e.d.f.g.h"), createModuleMember("abc.d.e")))
