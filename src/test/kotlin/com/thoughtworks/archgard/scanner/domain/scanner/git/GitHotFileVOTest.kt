...
internal class GitHotFileVOTest {
    ...
    internal fun shouldReturnFalseWhenCheckIfJVMClassGivenNonJVMFile() {
        val gitHotFile = GitHotFileVO(1, "README.MD", 10)
    ...
    internal fun shouldReturnTrueWhenCheckIfJVMClassGivenJavaFile() {
        val gitHotFile = GitHotFileVO(1, "src/main/java/com/qicaisheng/parkinglot/HTMLReportVisitor.java", 10)
    ...
    internal fun shouldReturnTrueWhenCheckIfJVMClassGivenKotlinFile() {
        val gitHotFile = GitHotFileVO(1, "src/main/kotlin/com/qicaisheng/parkinglot/HTMLReportVisitor.kt", 10)
    ...
    internal fun shouldGetModuleNameGivenJVMFileInModuleSrcTopDirection() {
        val gitHotFile = GitHotFileVO(1, "dubbo-samples-zookeeper/src/main/java/org/apache/dubbo/samples/action/GreetingServiceConsumer.java", 10)
