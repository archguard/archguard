INSERT INTO dubbo_service_config (id, project_id, interface, ref, version, `group`, module_id)
...
INSERT INTO dubbo_module (id, project_id, name, path)
VALUES ('ce818d60-f54e-41b7-9851-9b0eb212548d', 1, 'dubbo-samples-groupA', '../dubbo-samples/java/dubbo-samples-groupA');
INSERT INTO dubbo_module (id, project_id, name, path)
VALUES ('1debc4fc-5fa9-40ad-9939-b69effd54c0f', 1, 'dubbo-samples-groupB', '../dubbo-samples/java/dubbo-samples-groupB');
INSERT INTO dubbo_module (id, project_id, name, path)
VALUES ('a4a8b3c5-a17c-42f7-8733-d9823a6c790a', 1, 'dubbo-samples-groupC', '../dubbo-samples/java/dubbo-samples-groupC');
