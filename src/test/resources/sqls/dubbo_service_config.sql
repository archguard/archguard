INSERT INTO code_framework_dubbo_service_config (id, system_id, interface, ref, version, `group`, module_id)
...
INSERT INTO code_framework_dubbo_module (id, system_id, name, path)
